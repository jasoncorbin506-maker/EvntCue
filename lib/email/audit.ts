...
/**
 * Email send-audit sink (Phase 2 — booking lifecycle).
 *
 ...
 * skip to `email_send_audit` (migration 074).
 *
 ...
 * caller: an audit-write failure (including the table not existing yet, before
