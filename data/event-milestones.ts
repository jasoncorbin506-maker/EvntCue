...
const WEDDING: Record<string, Milestone[]> = {
  catholic: [
    ...
    { key: "wedding_vendor_lock", label: "Vndr lock", lead: 4, detail: "Photo, florals, music" },
  ...
  protestant: [
    ...
    { key: "wedding_save_the_dates", label: "Save-the-dates", lead: 6 },
    { key: "wedding_vendor_lock", label: "Vndr lock", lead: 4 },
    { key: "wedding_invitations", label: "Invitations", lead: 2 },
  ...
  jewish: [
    ...
    { key: "wedding_vendor_lock", label: "Vndr lock", lead: 6, detail: "Kosher catering specialty" },
  ...
  islamic: [
    ...
    { key: "wedding_vendor_lock", label: "Vndr lock", lead: 3 },
  ...
  multicultural: [
    ...
    { key: "wedding_vendor_lock", label: "Vndr lock", lead: 5, detail: "Cultural specialty Vndrs fill early" },
    { key: "wedding_invitations", label: "Invitations", lead: 2 },
...
const SOCIAL: Record<string, Milestone[]> = {
  ...
  bar_bat_mitzvah: [
    ...
    { key: "social_bar_bat_mitzvah_vendor_lock", label: "Vndr lock", lead: 6 },
  ...
  sweet_16: [
    ...
    { key: "social_sweet_16_vendor_lock", label: "Vndr lock", lead: 2 },
  ...
  milestone_birthday: [
    ...
    { key: "social_milestone_birthday_vendor_lock", label: "Vndr lock", lead: 1 },
...
const CORPORATE: Record<string, Milestone[]> = {
  ...
  holiday_party: [
    ...
    { key: "corporate_holiday_party_vendor_lock", label: "Vndr lock", lead: 3 },
...
const WEDDING_CORE: Milestone[] = [
  ...
  { key: "wedding_vendor_lock", label: "Vndr lock", lead: 4, detail: "Photo · florals · music · baker" },
...
function genericFallback(): Milestone[] {
  return [
    ...
    { key: "fallback_vendor_lock", label: "Vndr lock", lead: 4 },
